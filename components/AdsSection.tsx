    ...
    return (
        <AnimatePresence mode='wait'>
            ...
            >
                ...
                <ProductsCarousel />
                <div className='hidden lg:flex lg:gap-16 md:gap-5 w-full justify-center'>
                    {Products.map((product) => (
                        <motion.div
                            ...
                            transition={{ duration: 1 }}
                            viewport={{ once: false }}
                            className='flex flex-col px-8 rounded-3xl duration-700 shadow- backdrop-blur-sm bg-gray-100 dark:bg-dark-600 border-2 border-gray-50 dark:border-dark-500 dark:shadow-black shadow-black/30 items-center '
                        >
